...
### Set Parameter ###
# 1. Point to the path of your KPScript.exe -> Mostly here /usr/lib/keepass/KPScript.exe
# 2. Point to the path of your Database.kdbx -> Like /home/username/Database.kdbx
